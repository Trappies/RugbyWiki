...
async function scrapeSixNationsFixtures() {
    try {
        const response = await axios.get('https://www.rugbypass.com/european-champions-cup/fixtures-results/');
...
async function scrapeSixNationsStandings() {
    try {
        const response = await axios.get('https://www.rugbypass.com/european-champions-cup/standings/');
        const $ = cheerio.load(response.data);
