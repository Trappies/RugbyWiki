...
async function scrapePauPlayers() {
  try {
...
async function updateHTMLWithPlayers(playerData) {
  try {
    ...
    console.log('HTML file updated with the latest Pau player details.');
  } catch (error) {
