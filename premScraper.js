...
async function scrapePremiershipFixtures() {
    try {
        const response = await axios.get('https://www.rugbypass.com/premiership/fixtures-results/');
...
async function updateHTMLWithFixtures(fixtures) {
    try {
        const htmlFilePath = 'premiership.html';
        ...
        console.log('HTML file updated with the latest Premiership fixtures.');
    } catch (error) {
        console.error('Error updating HTML file:', error.message);
    }
}

scrapePremiershipFixtures().then((fixtures) => {
    updateHTMLWithFixtures(fixtures);
  });

async function scrapePremiershipStandings() {
    try {
        const response = await axios.get('https://www.rugbypass.com/premiership/standings/');
        const $ = cheerio.load(response.data);
...
async function updateHTMLWithStandings(standings) {
    try {
        ...
        fs.writeFileSync(htmlFilePath, $.html());
        console.log('HTML file updated with the latest Premiership standings.');
    } catch (error) {
...
scrapePremiershipStandings().then((standings) => {
