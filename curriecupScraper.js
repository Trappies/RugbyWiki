...
async function scrapeCurrieCupFixtures() {
    try {
        const response = await axios.get('https://www.rugbypass.com/currie-cup/fixtures-results/');
        ...
        console.error('Error scraping NPC fixtures:', error.message);
        return [];
    }
}
...
async function updateHTMLWithFixtures(fixtures) {
    try {
        const htmlFilePath = 'curriecup.html';
        ...
        console.log('HTML file updated with the latest Currie Cup fixtures.');
    } catch (error) {
        console.error('Error updating HTML file:', error.message);
    }
}

scrapeCurrieCupFixtures().then((fixtures) => {
    updateHTMLWithFixtures(fixtures);
  });

async function scrapeCurrieCupStandings() {
    try {
        const response = await axios.get('https://www.rugbypass.com/currie-cup/standings/');
        const $ = cheerio.load(response.data);
        ...
        console.error('Error scraping Currie Cup standings:', error.message);
        return [];
    }
}
...
async function updateHTMLWithStandings(standings) {
    try {
        ...
        fs.writeFileSync(htmlFilePath, $.html());
        console.log('HTML file updated with the latest Currie Cup standings.');
    } catch (error) {
...
scrapeCurrieCupStandings().then((standings) => {
