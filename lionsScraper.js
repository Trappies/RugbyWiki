...
async function scrapeLionsPlayers() {
  try {
...
scrapeLionsPlayers().then((players) => {
  if (players.length > 0) {
...
async function updateHTMLWithPlayers(playerData) {
  try {
    ...
    console.log('HTML file updated with the latest Lions player details.');
  } catch (error) {
